...
selenium.type("name=pattern", ("est te").toString())
selenium.click("xpath=//button[@type='submit']")
softAssertion.assertEquals("test test test", selenium.getText("xpath=(.//*[normalize-space(text()) and normalize-space(.)='$'])[1]/following::span[1]"))
selenium.click("xpath=//*/text()[normalize-space(.)='']/parent::*")
selenium.click("name=pattern")
selenium.type("name=pattern", "ab")
selenium.sendKeys("name=pattern", Keys.ENTER)
softAssertion.assertEquals("@5?>4020B5;8 =5 =0945=K", selenium.getText("xpath=(.//*[normalize-space(text()) and normalize-space(.)='$'])[1]/following::td[1]"))
